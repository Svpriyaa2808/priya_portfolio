    ...
    <div className="text-white m-4 grow">
      <div className="flex flex-col md:flex-row mt-4">
        <div className="basis-[40%] ">
          <p className="text-[18px] md:text-xl 2xl:text-2xl lg:text-2xl m-4 lg:m-8 px-8">Hey, I'm <span className="text-[#B4ADA3] font-bold">Priya</span> 👋🏻</p>
          <h1 className="text-3xl md:text-5xl 2xl:text-6xl font-bold text-center m-2 mt-6">Frontend Developer</h1>
          <p className=" md:text-[16px] lg:text-xl 2xl:text-2xl m-8 px-0 md:px-8">I'm a Front-End Development student . I'm reaching out to see if your team might be open to taking on a front-end development intern</p>
