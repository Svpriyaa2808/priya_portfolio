...
const ProjectPage = () => {
    return (
        <div className="grow text-center">
            <div className="text-white m-4 mt-8 text-[18px] text-justify">
                <p className="indent-9 m-4 mx-8">As a frontend development student, I've worked on a variety of projects as part of my coursework, focusing on building responsive, accessible, and user-friendly interfaces. 
                ...
                <p  className="indent-9 m-4 mx-8">Below are some of the key projects I completed during my course. They reflect my growth, problem-solving skills, and attention to detail as an aspiring frontend developer.</p>
            </div> 
